export const experiences = [
  ...
  {
    id: 4,
    title: 'Professor — Software Architecture & Programming',
  ...
  },
  {
    ...
    location: 'Remote',
    description:
      'Led a 10+ person team delivering multiplayer backend services and game design across 5 concurrent projects under Agile sprints.',
    responsibilities: [
      'Led 10+ person team across 5 concurrent projects under Agile sprints',
  ...
  },
  {
    ...
    location: 'Buenos Aires, Argentina',
    description:
      'Full-stack web development with a React and TypeScript frontend and a C#/.NET and Java backend with PostgreSQL databases.',
    responsibilities: [
      'Frontend development with React and TypeScript',
      'Backend API development with C#/.NET and Java',
      'PostgreSQL database design and optimization',
      'JWT authentication and role-based access control',
      'Unit testing (xUnit/NUnit on the backend, Jest on the frontend)',
    ],
    technologies: ['React', 'TypeScript', 'C#', '.NET', 'Java', 'PostgreSQL', 'Jest'],
    icon: 'Code2',
  },
  {
    id: 9,
    ...
    responsibilities: [
      ...
      'Unit testing with pytest / Django test framework',
    ],
    technologies: ['Python', 'Django', 'PostgreSQL', 'API Development', 'pytest'],
    icon: 'Database',
  },
];
