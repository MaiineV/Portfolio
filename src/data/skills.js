export const skillsData = [
  ...
  },
  {
    ...
    icon: 'Layers',
    description: 'Designing maintainable systems and testing them',
    skills: [
      { name: 'SOLID',              level: 90, description: 'Object-oriented design principles' },
      { name: 'Design Patterns',    level: 85, description: 'GoF and architectural patterns' },
      { name: 'MVC',                level: 85, description: 'Model-View-Controller architecture' },
      { name: 'Clean Architecture', level: 80, description: 'Layered, dependency-inverted design' },
      { name: 'Unit Testing',       level: 80, description: 'xUnit, NUnit, Jest, pytest' },
      { name: 'Hexagonal',          level: 75, description: 'Ports and adapters architecture' },
      { name: 'DDD',                level: 75, description: 'Domain-driven design' },
      { name: 'Microservices',      level: 75, description: 'Distributed service architecture' },
      { name: 'Event-Driven',       level: 75, description: 'Asynchronous, message-based systems' },
    ],
  },
  {
    category: 'AI & Automation',
    icon: 'Bot',
    description: 'Building with AI tooling and automating workflows',
    skills: [
      { name: 'AI-Assisted Development', level: 85, description: 'Claude Code, Copilot for building software' },
      { name: 'Spec-Driven Development', level: 80, description: 'Spec-first delivery (SDD)' },
      { name: 'Automation Tooling',      level: 80, description: 'Scripts, agents, and workflow automation' },
      { name: 'AI Agents',               level: 75, description: 'Custom agents and skills (claude-code-arcane)' },
    ],
  },
  {
